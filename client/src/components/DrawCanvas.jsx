    ...
    return (
      <div className ="draw-canvas">
        ...
        <div className="button-cluster">
          <img
            style={{'backgroundColor': this.state.eColor}}
            onClick={this.onEraserClick.bind(this)}
            className="eraser" src="erasericon.png">
          </img>
          <img
            style={{'backgroundColor': this.state.dColor}}
            onClick={this.onDrawClick.bind(this)}
            className="drawBrush" src="brushicon.png">
          </img>
          <input
            className="clearBtn"
